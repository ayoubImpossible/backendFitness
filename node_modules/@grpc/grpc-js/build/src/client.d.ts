...
import { ClientDuplexStream, ClientReadableStream, ClientUnaryCall, ClientWritableStream, ServiceError, SurfaceCall } from '@grpc/grpc-js/build/src/callgrpc-js/build/src/call';
import { CallCredentials } from '@grpc/grpc-js/build/src/call-credentialsd/src/call-credentials';
import { Channel } from '@grpc/grpc-js/build/src/channelc-js/build/src/channel';
...
import { ClientMethodDefinition } from '@grpc/grpc-js/build/src/make-client/build/src/make-client';
import { Interceptor, InterceptorProvider } from '@grpc/grpc-js/build/src/client-interceptorsrc/client-interceptors';
import { ServerUnaryCall, ServerReadableStream, ServerWritableStream, ServerDuplexStream } from '@grpc/grpc-js/build/src/server-call/build/src/server-call';
