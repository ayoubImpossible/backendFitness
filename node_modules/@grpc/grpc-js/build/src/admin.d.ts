import { ServiceDefinition } from '@grpc/grpc-js/build/src/make-client/build/src/make-client';
import { Server, UntypedServiceImplementation } from '@grpc/grpc-js/build/src/serverpc-js/build/src/server';
