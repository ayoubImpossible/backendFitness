...
import type { Deserialize, Serialize } from '@grpc/grpc-js/build/src/make-client/build/src/make-client';
import { Metadata } from '@grpc/grpc-js/build/src/metadata-js/build/src/metadata';
import type { ObjectReadable, ObjectWritable } from '@grpc/grpc-js/build/src/object-streamuild/src/object-stream';
import type { StatusObject, PartialStatusObject } from '@grpc/grpc-js/build/src/call-interfaceild/src/call-interface';
import type { Deadline } from '@grpc/grpc-js/build/src/deadline-js/build/src/deadline';
import type { ServerInterceptingCallInterface } from '@grpc/grpc-js/build/src/server-interceptorsrc/server-interceptors';
