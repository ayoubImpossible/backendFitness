...
import { Credentials } from 'google-auth-library/build/src/auth/credentialsibrary/build/src/auth/credentials';
import { AuthClient, AuthClientOptions } from 'google-auth-library/build/src/auth/authclientlibrary/build/src/auth/authclient';
import { BodyResponseCallback, Transporter } from 'google-auth-library/build/src/transportersrary/build/src/transporters';
import { GetAccessTokenResponse, Headers } from 'google-auth-library/build/src/auth/oauth2clientbrary/build/src/auth/oauth2client';
import { SnakeToCamelObject } from 'google-auth-library/build/src/utilauth-library/build/src/util';
/**
 ...
 */
export { DEFAULT_UNIVERSE } from 'google-auth-library/build/src/auth/authclientlibrary/build/src/auth/authclient';
/**
