 ...
 */
import { GetTokenResponse, OAuth2Client, OAuth2ClientOptions } from 'google-auth-library/build/src/auth/oauth2clientbrary/build/src/auth/oauth2client';
import { AuthClient } from 'google-auth-library/build/src/auth/authclientlibrary/build/src/auth/authclient';
import { IdTokenProvider } from 'google-auth-library/build/src/auth/idtokenclientrary/build/src/auth/idtokenclient';
import { SignBlobResponse } from 'google-auth-library/build/src/auth/googleauthlibrary/build/src/auth/googleauth';
