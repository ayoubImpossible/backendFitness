...
import { CredentialBody, Credentials, JWTInput } from 'google-auth-library/build/src/auth/credentialsibrary/build/src/auth/credentials';
import { IdTokenProvider } from 'google-auth-library/build/src/auth/idtokenclientrary/build/src/auth/idtokenclient';
import { GetTokenResponse, OAuth2Client, OAuth2ClientOptions, RequestMetadataResponse } from 'google-auth-library/build/src/auth/oauth2clientbrary/build/src/auth/oauth2client';
