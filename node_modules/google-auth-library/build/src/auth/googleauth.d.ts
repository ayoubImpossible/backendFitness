...
import { DefaultTransporter, Transporter } from 'google-auth-library/build/src/transportersrary/build/src/transporters';
import { CredentialBody, ImpersonatedJWTInput, JWTInput } from 'google-auth-library/build/src/auth/credentialsibrary/build/src/auth/credentials';
import { IdTokenClient } from 'google-auth-library/build/src/auth/idtokenclientrary/build/src/auth/idtokenclient';
import { GCPEnv } from 'google-auth-library/build/src/auth/envDetect-library/build/src/auth/envDetect';
import { JWT, JWTOptions } from 'google-auth-library/build/src/auth/jwtclient-library/build/src/auth/jwtclient';
import { Headers, OAuth2ClientOptions } from 'google-auth-library/build/src/auth/oauth2clientbrary/build/src/auth/oauth2client';
import { UserRefreshClient, UserRefreshClientOptions } from 'google-auth-library/build/src/auth/refreshclientrary/build/src/auth/refreshclient';
import { Impersonated, ImpersonatedOptions } from 'google-auth-library/build/src/auth/impersonatedbrary/build/src/auth/impersonated';
import { ExternalAccountClientOptions } from 'google-auth-library/build/src/auth/externalclientary/build/src/auth/externalclient';
import { BaseExternalAccountClient } from 'google-auth-library/build/src/auth/baseexternalclientbuild/src/auth/baseexternalclient';
import { AuthClient, AuthClientOptions } from 'google-auth-library/build/src/auth/authclientlibrary/build/src/auth/authclient';
import { ExternalAccountAuthorizedUserClient } from 'google-auth-library/build/src/auth/externalAccountAuthorizedUserClientternalAccountAuthorizedUserClient';
import { AnyAuthClient } from 'google-auth-libraryogle-auth-library';
/**
